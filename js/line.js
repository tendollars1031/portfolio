...
function InitialLineBtn() {
    ...
    r.BUTTON_URL[r.BUTTON_TYPES.SHARE] = "/widget/share?", r.BUTTON_URL[r.BUTTON_TYPES.FRIEND] = "/widget/friend?", r.BUTTON_URL[r.BUTTON_TYPES.LIKE] = "/widget/like?";
    var s = [],
        o = function() {
    ...
    "interactive" === h || "complete" === h ? window.addEventListener("load", o, !1) : document.addEventListener("DOMContentLoaded", o, !1), t.prototype.makeButton = function(t) {
        ...
        if ("https://timeline.line.me" === t.origin && (i = !0), i && /^\{.+\}$/.test(e)) {
            var n = JSON.parse(e),
                o = s[n.buttonId];
            if ("setTitle" == n.type && (o.elIframe.title = n.title), "resize" === n.type && (o.elIframe.style.width = n.width + "px", o.elIframe.style.height = n.height + "px", o = null), "refresh" === n.type)
